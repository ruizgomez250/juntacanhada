...
<!--*******************************************************Empieza el contenido****************************************************************-->
  ...
  $sql = "SELECT cli.id,cli.cedula,cli.nombre,cli.apellido,cli.telefono,cli.telefono1,cat.descripcion,sector.descripcion,medid.codigo_medidor 
      ...
      inner join categoria cat on cat.id = cli.id_categoria
      inner join opcion sector on sector.id = cli.id_sector
      inner join medidor medid on medid.id = cli.id_medidor 
      inner join factura_encabezado enc on enc.id_cliente=cli.id where enc.estado=2 order by cli.id;";
  $stmt = pg_exec($conexion, $sql );
        ...
        <div class="modal-header align-self-center">
          ...
          <div class="card">
            <div class="card-header">
              <img src="icon/card-heading.svg" width="25" height="25" border="0" id="buscarCod" /> <strong>Seleccione la fecha de la Factura</strong>
                ...
                <div class="row">
                  ...
                  <div class="col-12 align-self-end">
                    <div class="form-group">
                        ...
                        <div class="card">
                          <div class="card-header text-center">
                            <h3><strong>Orden de pago con numero de factura emitido por fechas</strong></h3>
                          </div>
...
<!--****************************************************termina el contenido**********************************************************************-->
    ...
    <script src="scripts/verFacturasUsuario.js"></script>
