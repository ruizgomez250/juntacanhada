...
$('#guardar').click(function() {
    ...
    horaDesde = '&horadesde=' + document.getElementById('horadesde').value;
    horaHasta = '&horahasta=' + document.getElementById('horahasta').value;
    codFunc = '&codfuncionario=' + document.getElementById('codfunc').value;
    nombre = '&nombapellido=' + document.getElementById('nombre').value;
    cedula = '&cedfuncionario=' + document.getElementById('cedula').value;
    observacion = '&observacion=' + document.getElementById('observacion').value;
    feriado = '&feriado=' + document.getElementById('feriado').value;
    var win = window.open('reporteMarcacionFecha2.php?' + fechaDesde + fechaHasta + codFunc + nombre + cedula + horaDesde + horaHasta + observacion + feriado, '_blank');
    ...
    $.ajax({
        ...
        success: function(res) {
            if (!res) {
                ...
                document.getElementById("horario").value = datos[7];
                document.getElementById("horadesde").value = datos[8];
                document.getElementById("horahasta").value = datos[9];
                document.getElementById("estado").value =datos[10];
