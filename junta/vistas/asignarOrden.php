...
<!--*******************************************************Empieza el contenido****************************************************************-->
  ...
  $paginaGuardado='';
  if($modificar == 0){
    $paginaGuardado='../php/Cliente.php?op=orden';
  }else{
  ...
  $sql = "SELECT cli.id,cli.nombre,cli.apellido,cli.orden
      FROM cliente cli 
      ;";
  $stmt = pg_exec($conexion, $sql );
  $bodyTablaPermiso=null;
  while( $row = pg_fetch_array( $stmt) ) {
        ...
        $documento='';
          $bodyTablaPermiso=('<tr><td class="text-center ">'.$orden.'</td>
                          <td class="text-center ">'.$codUsu.'</td>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <h2 class="txtBlue text-center">Asignar Orden a Usuario</h2>
        <div class="card">
        ...
        <form class=" inline-block" id="form" enctype="multipart/form-data" method="post" action="<?php echo ($paginaGuardado); ?>" name="  form" novalidate>
          ...
          <div class="row">
            <div class="col-md-2">
              ...
              <label id="funcmensaje" name="funcmensaje" class="btn-danger" >Este usuario se usa como referencia!!!</label>
            </div>
            <div class="col-md-2">
              <label for="cedul">
          ...
          <div class="row">
            <div class="col-md-2">
              ...
              <label id="funcmensaje" name="funcmensaje" class="btn-info" >Este usuario se ubicara despues del usuario referencia!!!</label>
            </div>
            <div class="col-md-2">
              <label for="cedul">
      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          ...
          <div class="table-responsive">
            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      <thead align="center">
                          <tr class="fondo">
                <th class="txtWhite"><b>Orden</b></th>
...
<!--****************************************************termina el contenido**********************************************************************-->
    ...
    <!-- código JS propìo-->    
    <script src="scripts/asignarOrden.js"></script> 
