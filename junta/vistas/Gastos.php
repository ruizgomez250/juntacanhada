...
<?php 
  ...
  if(isset($_GET['moadfnmgvlfjhdif'])){
    ...
    $sql = "SELECT id,descripcion,monto_total FROM costo
      WHERE id = $modificar;";
      $stmt = pg_exec($conexion, $sql );
      while( $row = pg_fetch_array( $stmt) ) {
        $id1=$row['id'];
        $descripcion1=$row['descripcion'];
        $monto1=$row['monto_total'];
      }
  }
  $paginaGuardado='';
  if($modificar == 0){
    $paginaGuardado='../php/Gastos.php?op=guardar';
  }else{
    $paginaGuardado='../php/Gastos.php?op=modificar&id='.$_GET['moadfnmgvlfjhdif'];
  }
  ...
  while( $row = pg_fetch_array( $stmt) ) {
        ...
        $bodyTablaPermiso=('<tr><td class="text-center ">'.$id.'</td>
                        ...
                        <td class="text-left">
                            ...
                            <a href="Gastos.php?moadfnmgvlfjhdif='.$id.'"><button  name='.$id.' class="ieditar btn-success btn-sm"><img class="imagen" style="cursor:pointer;"  src="icon/Check-circle-fill.svg" width="20" height="20" border ="0" id= "editar" title="Seleccionar"/></button></a>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <h2 class="txtBlue text-center">Agregar/Modificar Costos</h2>
        <div class="card">
              <div class="card-header">
                  <img src="icon/plus-circle.svg" width="25" height="25" border ="0" id= "buscarCod"/><?php if(isset($_GET['moadfnmgvlfjhdif']))echo('<a href="Gastos.php"> <button class="btn btn-sm btn-secondary">Nuevo</button></a>'); ?> 
              </div>
              <div class="card-body">
        ...
        <form class=" inline-block" id="form" enctype="multipart/form-data" method="post" action="<?php echo ($paginaGuardado); ?>" name="  form" novalidate>
          ...
          <div class="row">
            ...
            <div class="col-md-7" id="Funcionario1">
              ...
              <input id="descCosto" name="descCosto" class="form-control" type="text" value="<?php if(isset($_GET['moadfnmgvlfjhdif']))echo($descripcion1); ?>">
          ...
          <div class="row" >
            <div class="col-md-3" id="Funcionario5" >
              <label for="cedul" >
                <font style="vertical-align: inherit;">Guaranies Total</font>
              </label>
              <input id="costoGuaranies" name="costoGuaranies" class="form-control " type="text" value="<?php 
               if(isset($_GET['moadfnmgvlfjhdif'])){if($esPorcentaje1 != 1)echo($monto1);} ?>">
