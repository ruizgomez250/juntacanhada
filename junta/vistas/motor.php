...
<?php 
  ...
  if(isset($_GET['moadfnmgvlfjhdif'])){
    ...
    $sql = "SELECT id,descripcion,fecha
      FROM motor
      WHERE id = $modificar;";
  ...
  $paginaGuardado='';
  if($modificar == 0){
    $paginaGuardado='../php/Motor.php?op=guardar';
  }else{
    $paginaGuardado='../php/Motor.php?op=modificar&id='.$_GET['moadfnmgvlfjhdif'];
  }
  echo('<input id="modificarVerif" name="modificarVerif" value ="'.$modificar.'" style="display:none">');
  $sql = "SELECT id,descripcion,fecha
      FROM motor order by fecha;";
  $stmt = pg_exec($conexion, $sql );
  ...
  while( $row = pg_fetch_array( $stmt) ) {
        ...
        $bodyTablaPermiso=('<tr><td class="text-center ">'.$id.'</td>
                        ...
                        <td class="text-left">
                            ...
                            <a href="motor.php?moadfnmgvlfjhdif='.$id.'"><button  name='.$id.' class="ieditar btn-success btn-sm"><img class="imagen" style="cursor:pointer;"  src="icon/Check-circle-fill.svg" width="20" height="20" border ="0" id= "editar" title="Seleccionar"/></button></a>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <h2 class="txtBlue text-center">Agregar/Modificar Motor</h2>
        <div class="card">
              <div class="card-header">
                  <img src="icon/plus-circle.svg" width="25" height="25" border ="0" id= "buscarCod"/><?php if(isset($_GET['moadfnmgvlfjhdif']))echo('<a href="motor.php"> <button class="btn btn-sm btn-secondary">Nuevo</button></a>'); ?> 
              </div>
              <div class="card-body">
      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <form class=" inline-block" id="form" enctype="multipart/form-data" method="post" action="<?php echo ($paginaGuardado); ?>" name="  form" novalidate>
          <div class="row">
            <div class="col-md-2">
              <label for="cedul">
                <font style="vertical-align: inherit;">Codigo Motor</font>
              </label>
          ...
          <div class="row">
            ...
            <div class="col-md-6" id="Funcionario1">
              <label for="cedul">
            ...
            <div class="col-md-6" id="Funcionario5" >
              <label for="cedul" >
                <font style="vertical-align: inherit;">Fecha</font>
              </label>
              <input id="costoConsumoMinimo" name="costoConsumoMinimo" class="form-control " type="date" value="<?php if(isset($_GET['moadfnmgvlfjhdif']))echo($fecha1); else echo date('Y-m-d'); ?>" >
      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          ...
          <div class="table-responsive">
            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <th class="txtWhite"><b>Fecha</b></th>
