  ...
  <div class="container">
		...
		<div class="row">
			...
			<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<h2 class="txtBlue text-center">Realizar Pago por Usuario</h2>
...
<div class="modal fade" id="modalTomaMedida" name="modalTomaMedida">
                  ...
                  <div class="col-12 align-self-end">
                      	...
                      	<div class="card">
													...
													<div class="row">
															<div class="col-1 text-center">
																		<label id="codCliente"></label>
															</div>
															<div class="col-4">
																		<label id="cliente"></label>
															</div>
															<div class="col-2">
																		<label id="numOrd"></label>
															</div>
															<div class="col-3">
																		<label id="fechEm"></label>
															</div>
															<div class="col-2">
																		<label id="fechVenc"></label>
															</div>
													</div>		
											</div>
                    			...
                    			<thead align="center">
                        	<tr class="fondo">
													<th class="txtWhite"><b>Cantidad</b></th>
													<th class="txtWhite"><b>Descripcion</b></th>
													<th class="txtWhite"><b>Precio Unitario</b></th>
        			...
        			<div class="row">
        							<div class="col-3">
												...
												<input type="text" name="numFac" id="numFac" class="form-control" value="" placeholder="Numero">
												<label id="mensajeFactura" name="mensajeFactura" class="btn-danger" style="display:none">No existe orden de pago pendiente!!!</label>
											</div>
											<div class="col-3">
												<label>Monto a Abonar</label>
												<input type="number" name="montoAbonar" id="montoAbonar" class="form-control" value="" placeholder="Numero">
												<input type="hidden" name="montoAbonar1" id="montoAbonar1" class="form-control" value="" placeholder="Numero">
												
											</div>
											<div class="col-3 text-center">
												<label>Diferencia</label>
												<h1 id="diferenciaAbonar">
												</h1>
											</div>
											<div class="col-3 ">
												<button class="btn btn-primary" id="pagar" type="submit" disabled>
					                Pagar
					              </button>
											</div>
...
<!--****************************************************termina el contenido**********************************************************************-->
    ...
    <script src="scripts/cargarPago.js"></script>
