...
<?php 
  ...
  $sql = "SELECT cli.id,cli.cedula,cli.nombre,cli.apellido,cli.telefono,cli.telefono1,cat.descripcion,sector.descripcion,medid.codigo_medidor,cli.orden 
      FROM cliente cli 
      inner join categoria cat on cat.id = cli.id_categoria
      inner join opcion sector on sector.id = cli.id_sector
      inner join medidor medid on medid.id = cli.id_medidor order by cli.orden;";
  $stmt = pg_exec($conexion, $sql );
  $bodyTablaPermiso=null;
  while( $row = pg_fetch_array( $stmt) ) {
        $ordenExcel=$row['orden'];
        $id1=$row['id'];
        $cedula1=$row['cedula'];
        $nombre1=$row['nombre'];
        ...
        $verif='';
        $documento='';
        $bodyTablaPermiso=('<tr><td class="text-center ">'.$ordenExcel.'</td>
      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          ...
          <div class="table-responsive">
            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      <thead align="center">
                          <tr class="fondo">
                <th class="txtWhite"><b>Orden Excel</b></th>
                <th class="txtWhite"><b>Codigo Usuario</b></th>
