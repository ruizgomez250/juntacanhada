...
//almacenar permisos asigandos
	...
	if (isset($fetch)) {
		...
		in_array(1, $valores)?$_SESSION['impuesto']=1:$_SESSION['impuesto']=0;
		in_array(2, $valores)?$_SESSION['cuentascont']=1:$_SESSION['cuentascont']=0;
		in_array(3, $valores)?$_SESSION['bancos']=1:$_SESSION['bancos']=0;
		in_array(4, $valores)?$_SESSION['mercaderias']=1:$_SESSION['mercaderias']=0;
		in_array(5, $valores)?$_SESSION['compras']=1:$_SESSION['compras']=0;
		in_array(6, $valores)?$_SESSION['remisionmerc']=1:$_SESSION['remisionmerc']=0;
		in_array(7, $valores)?$_SESSION['ventas']=1:$_SESSION['ventas']=0;
		in_array(8, $valores)?$_SESSION['acceso']=1:$_SESSION['acceso']=0;
		in_array(9, $valores)?$_SESSION['zonasusu']=1:$_SESSION['zonasusu']=0;
		in_array(10, $valores)?$_SESSION['categusu']=1:$_SESSION['categusu']=0;
		in_array(11, $valores)?$_SESSION['situacionusu']=1:$_SESSION['situacionusu']=0;
		in_array(12, $valores)?$_SESSION['usuariosjunta']=1:$_SESSION['usuariosjunta']=0;
		in_array(13, $valores)?$_SESSION['costosfactura']=1:$_SESSION['costosfactura']=0;
		in_array(14, $valores)?$_SESSION['costosusuario']=1:$_SESSION['costosusuario']=0;
		in_array(15, $valores)?$_SESSION['lecturamedidor']=1:$_SESSION['lecturamedidor']=0;
		in_array(16, $valores)?$_SESSION['extracto']=1:$_SESSION['extracto']=0;
