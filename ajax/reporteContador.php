<?php 
require_once "../modelos/ReporteContador.php";
if (strlen(session_id())<1) 
	session_start();

$ingreso=new ReporteContador();
    ...
    case 'listar':
		...
		while ($reg=$rspta->fetch_object()) {
			if($fac != $reg->facnro){
				...
				$anulado='Anulado';
				$total=$reg->impmin + $reg->impexe + $reg->impexe;
				$data[]=array(
	            "0"=>$reg->cedularuc,
