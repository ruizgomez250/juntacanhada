...
?>
          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Tomar Lectura </h1>
              ...
              <form action="" name="formulario" id="formulario" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="row text-center">
                    <div class="col-sm-4" style="margin-left: 5%;">
                      <div class="form-group">
                        ...
                        <input id="fechaLectura" name="fechaLectura" style="font-size: 35px; text-align: center;" class="form-control" type="number" placeholder="Lectura Anterior" required readonly>
                    ...
                    <div class="col-sm-4" style="margin-right: 5%;">
                      <div class="form-group">
                        <input type="hidden" name="hidr" id="hidr" class="form-control" value="" placeholder="Lectura Actual">
                        <label>Lectura Actual</label>
                        <input type="hidden" name="idlec" id="idlec" class="form-control" value="" placeholder="Lectura Actual">
                        <input type="number" name="lectura" id="lectura" style="font-size: 35px; text-align: center;" class="form-control" placeholder="Lectura Actual" required>
                  ...
                  <div class="row">
                    <div class="col-sm-3 ">
                      <div class="form-group">
                        <input type="hidden" name="mesperiodo" id="mesperiodo" class="form-control" value="" placeholder="Lectura Actual" readonly>

                      </div>
                    </div>
                    <div class="col-sm-3 ">
                      <div class="form-group">
                        <input type="hidden" name="anhoperiodo" id="anhoperiodo" class="form-control" value="" placeholder="Lectura Actual" readonly>
  ...
  require 'footer.php';
  ?>
  <script src="scripts/modificarLectura.js"></script>
<?php
}
