...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
     ...
     <select name="tipo_cuenta" id="tipo_cuenta" class="form-control selectpicker" required>
      ...
      <input class="form-control" type="text" name="num_cuenta" id="num_cuenta" maxlength="256" placeholder="Numero de Cuenta">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Cedula/R.U.C. Titular(*)</label>
      <input class="form-control" type="text" name="num_doc" id="num_doc" maxlength="256" placeholder="Cedula/R.U.C.">
    </div>
    <div class="row">
      <div class="form-group col-lg-6 col-md-6 col-xs-12">
