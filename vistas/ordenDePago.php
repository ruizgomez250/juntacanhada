...
<div class="box-header with-border">
  <h1 class="box-title">Orden de Pago </h1>
...
<div class="panel-body" style="height: 400px;" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-8 col-md-8 col-xs-12">
     ...
     <input class="form-control" type="text" name="tipo_comprobante" id="tipo_comprobante" maxlength="7" placeholder="Timbrado" style="display: none">
    </div>
    <div id="fact">
       <div class="form-group col-lg-2 col-md-2 col-xs-6">
        <label for="">Año(*): </label>
        <input class="form-control" type="text" name="serie_comprobante" id="serie_comprobante" maxlength="7" placeholder="Timbrado" style="display: none">
      </div>
    </div>
     <div class="form-group col-lg-2 col-md-2 col-xs-6">
      <input class="form-control" type="text" name="num_comprobante" id="num_comprobante" maxlength="10" placeholder="Número" style="display: none">
    </div>
    <div id="fact1">
      <div class="form-group col-lg-2 col-md-2 col-xs-6">
...
require 'footer.php';
 ?>
 <script src="scripts/ordenDePago.js"></script>
 <?php 
}
