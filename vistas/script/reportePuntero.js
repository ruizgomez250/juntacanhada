    ...
    table1=$('#example').DataTable({
        ...
        "columns":[
            ...
            "render": function(data, type, full, meta) {
                ...
                return '<button  name="'+id+'" class="addPuntero btn-xs btn-info "><img class="imagen" style="cursor:pointer;"  src="icon/plus-circle-fill.svg" width="20" height="20" border ="0" id= "agregar" title="Agregar Puntero" /></button>';
                },
            "bSortable": false,
            "bSearchable": false,
            "data": null
    ...
    table1=$('#example').DataTable({
        ...
        "columns":[
            ...
            "render": function(data, type, full, meta) {
                ...
                return '<button  name="'+id+'" class="addPuntero btn-xs btn-info "><img class="imagen" style="cursor:pointer;"  src="icon/eye-fill.svg" width="20" height="20" border ="0" id= "agregar" title="Agregar Puntero" /></button>';
                },
            "bSortable": false,
            "bSearchable": false,
            "data": null
...
function cargarTabla2(){
    ...
    table2=$('#addPunteroTabla').DataTable({
        ...
        "processing": true,
        "ajax": {
        "url": "../ajax/Puntero.php?op=traerVotantes1",
        "type": "POST",
        "data": {
            "cedula": codigo
        },
