...
function verifSiVoyCargarCedula(cedula){
        $.ajax({
                url: "../ajax/Voto.php",
                type: "POST",
                data: 'op=verificarCedula&cedula='+cedula,
                success: function(res) {
                     var datos = JSON.parse(res);
                        texto1=datos[1]+' C.I. '+datos[2];
                        document.getElementById('aVotar').innerHTML=texto1;
                        document.getElementById('aVotar1').innerHTML=' <strong class="btn-warning"> '+datos[0]+' MESA:'+datos[4]+' ORDEN:'+datos[5]+'</strong>';  
...
function verifSiVoyCargarSocio(socio){
        $.ajax({
                url: "../ajax/Voto.php",
                type: "POST",
                data: 'op=verificarSocio&socio='+socio,
                success: function(res) {
                     var datos = JSON.parse(res);
