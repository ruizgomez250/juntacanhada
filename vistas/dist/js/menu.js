...
(function ($) {
  ...
  // Checkboxes
  $container.append('<div class="text-right" ><svg  data-widget="control-sidebar"   role="button" width="20" height="20" fill="currentColor"><use xlink:href="icon/bootstrap-icons.svg#x-circle-fill"/></svg></div>'
  )
  $container.append(
    '<h5>Personalizar Menu</h5><hr class="mb-2"/>'
  )
  ...
  $container.append('<h6>Opcion del Menu</h6>')
  ...
  var $compact_sidebar_container = $('<div />', { class: 'mb-1' }).append($compact_sidebar_checkbox).append('<span>Compacta</span>')
  ...
  var $child_indent_sidebar_container = $('<div />', { class: 'mb-1' }).append($child_indent_sidebar_checkbox).append('<span>Identacion pequeña</span>')
  ...
  var $child_hide_sidebar_container = $('<div />', { class: 'mb-1' }).append($child_hide_sidebar_checkbox).append('<span>Mostrar Solo Icono Principal</span>')
  ...
  var $no_expand_sidebar_container = $('<div />', { class: 'mb-4' }).append($no_expand_sidebar_checkbox).append('<span>Desactivar Auto Expandir</span>')
  ...
  $container.append('<h6>Opcion Texto Pequeño</h6>')
  ...
  var $text_sm_body_container = $('<div />', { class: 'mb-1' }).append($text_sm_body_checkbox).append('<span>Cuerpo Menu</span>')
