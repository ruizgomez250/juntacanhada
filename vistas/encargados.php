...
<div class="panel-body" style="height: 400px;" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="hidden" name="tipo_persona" id="tipo_persona" value="Encargado">
     ...
     <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="hidden" name="tipo_documento" id="tipo_documento" maxlength="100" value="CEDULA" required>
...
require 'footer.php';
 ?>
 <script src="scripts/encargado.js"></script>
 <?php 
}
