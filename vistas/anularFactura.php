...
<div class="box-header with-border">
  <h1 class="box-title">Anular Factura
    <button class="btn btn-success" onclick="mostrarform(true)">Agregar<i class="fa fa-plus-circle"></i></button>
  </h1>
...
<div class="panel-body table-responsive" id="listadoregistros">
    <h5 class="box-title">Numero Factura: <input class="" type="number" name="nrofac" id="nrofac"><button type="submit" onclick="listar()" class="btn btn-info">Ver</button>
  </h5>
              ...
              <div>
                ...
                <div class="row">
                  ...
                  <div class="row">
                      ...
                      <button class=" btn btn-primary " id="guardarMedida" onclick="anular()" > Guardar</button>
...
require 'footer.php';
 ?>
 <script src="scripts/anularFactura.js"></script>
 <?php 
}
