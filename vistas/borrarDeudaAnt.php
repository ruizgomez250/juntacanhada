...
<div class="box-header with-border">
  <h1 class="box-title">Codigo Usuario: <input class="" type="number" name="fech" id="fech"><button onclick="listar()" class="btn btn-success">Buscar</button></h1>
...
require 'footer.php';
 ?>
 <script src="scripts/borrarDeudaAnt.js"></script>
 <?php 
}
