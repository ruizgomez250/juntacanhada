...
function listar(){
	...
	fechaDesde=document.getElementById('fechd').value;
	alert('ajax/reporteparaErssan.php?op=listarFecha&fecha='+fecha+'&fechaDesde='+fechaDesde);
	if(fecha.length >0){
			tabla=$('#tbllistado').dataTable({
				...
				"ajax":
				{
					url:'../ajax/reporteparaErssan.php?op=listarFecha&fecha='+fecha+'&fechaDesde='+fechaDesde,
					type: "get",
					dataType : "json",
					error:function(e){
