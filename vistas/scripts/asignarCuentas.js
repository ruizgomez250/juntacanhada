...
function guardar(id){
	$('#myModal').modal('hide');
	$.post("../ajax/opcionAConfigurar.php?op=modificar",{idOpcion : modif,idCuenta : id},
...
function listar(){
	tabla=$('#tbllistado').dataTable({
		...
		"ajax":
		{
			url:'../ajax/opcionAConfigurar.php?op=listar',
			type: "get",
			dataType : "json",
			error:function(e){
		...
		"order":[[0,"descripcion"]]//ordenar (columna, orden)
	}).DataTable();
}
