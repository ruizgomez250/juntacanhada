...
<div class="box-header with-border">
  <div class="row">
    <div class="col-12 text-center">
        <strong><h1 class="box-title">R.G. 90 Ventas</h1></strong>
    </div>
  </div>
        
  <h1 class="box-title"> Desde: <input class="" type="date" name="fechd" id="fechd"> Hasta: <input class="" type="date" name="fech" id="fech"><button onclick="listar()" class="btn btn-success">Generar</button></h1>
...
<div class="panel-body table-responsive" id="listadoregistros">
  <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover">
    <thead>
	     <th>R.U.C. Informante</th>
      <th>Nombre o Razon Social del Informante</th>
      <th>R.U.C. Nº de identificacion del Informado</th>
      <th>Tipo de Registro</th>
      <th>Tipo de Comprobante</th>
      <th>Fecha de Emision</th>
      <th>Condicion de la Operacion</th>
      <th>Timbrado del Comprobante</th>
      <th>Numero de Comprobante</th>
      <th>Monto Gravado 10%</th>
      <th>IVA 10%</th>
      <th>IVA 5%</th>
      <th>Monto no Grabado / Exenta</th>
      <th>Imputa IVA</th>
      <th>Imputa IRE</th>
      <th>Imputa IRP</th>
      <th>Numero Comprobante Asociado</th>
      <th>Timbrado del Comprobante Asociado</th>
    </thead>
    <tbody>
    </tbody>
    <tfoot>
...
require 'footer.php';
 ?>
 <script src="scripts/rg90ventas.js"></script>
 <?php 
}
