...
<div class="box-header with-border">
  <h1 class="box-title">Nota Credito </h1>
              ...
              <div>
                ...
                <form action="" name="formulario" id="formulario" method="POST">
                  <div class="row">
                      <div class="col-3">
                        <div class="col-3">
                        <h5><label>Fecha</label>
                        <input type="date" name="fecha" id="fecha" required></h5>
                      </div>
                        <h5><label>Timbrado</label>
                        <input type="text" name="timbrado" id="timbrado" required></h5>
                      </div>
                      <div class="col-3">
                        <h5><label>Nota Credito Nº</label>
                        <input type="text" name="numero" id="numero" required></h5>
                      </div>
                  </div>
                  <div class="row">
                      ...
                      <div class="col-3">
                        ...
                        <input type="number"  name="montoAbonar" id="montoAbonar"  class="btn-success"oninput="verifMonto()" required></h2>
...
require 'footer.php';
 ?>
 <script src="scripts/notaCredito.js"></script>
 <?php 
}
